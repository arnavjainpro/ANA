// Brand/platform glyphs not available in lucide-react 1.x (brand icons were removed).
...
export function WindowsIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className={className}>
      <path d="M3 5.1l7.4-1.02v7.14H3V5.1zm0 13.8l7.4 1.02v-7.06H3v6.04zm8.2 1.13L21 21.4v-8.44h-9.8v7.07zm0-15.99v7.18H21V2.6l-9.8 1.44z" />
    </svg>
  );
}
